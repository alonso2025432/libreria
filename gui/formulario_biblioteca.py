...
from models.biblioteca_modelo import agregar_biblioteca,obtener_biblioteca
...
def crear_biblioteca(interfaz):
    ...
    def cargar_bibliotecas():
        try:
            bibliotecas = obtener_biblioteca()
            ...
            messagebox.showerror("ERROR","No se pudieron cargar las bibliotecas: ",str(ex))
    cargar_bibliotecas()